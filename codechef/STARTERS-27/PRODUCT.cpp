...
void run_case(){
    ...
    int ans = c / gcd(b, c);
    /*-------------------------------------------------
     A . { (b / g) / (c / g) } -> min no to cancel A is c / g
     { (b / g) / (c / g) } to get the fraction b / c in the simplest 
     form we divide num and deno by the gcd(num, deno)
